...
unfundedBtn.addEventListener('onClick', filterUnfundedOnly);
fundedBtn.addEventListener('onClick', filterFundedOnly);
allBtn.addEventListener('onClick', showAllGames);
